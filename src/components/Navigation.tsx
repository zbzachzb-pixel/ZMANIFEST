      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <div>
              <span className="text-white font-bold text-xl tracking-tight">ZMANIFEST</span>
              <p className="text-xs text-slate-400 font-medium">Instructor Rotation System</p>
            </div>
          </Link>
                ...
                <div key={group.label} className="relative">
                  ...
                  {isOpen && (
                    <>
                      ...
                      {/* Dropdown Content */}
                      <div className="absolute top-full left-0 mt-2 w-56 bg-slate-800 border border-white/10 rounded-lg shadow-2xl overflow-hidden z-20 animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            {auth?.user ? (
              <div className="flex items-center gap-3 pl-4 border-l border-white/20">
                ...
                <button
                  ...
                  className="px-4 py-2 text-sm bg-red-500/20 hover:bg-red-500/30 text-red-300 rounded-lg transition-all font-medium border border-red-500/30 hover:border-red-500/50"
                  title="Sign Out"
                >
                  Sign Out
                </button>
              ...
              <Link
                href="/login"
                className="px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white rounded-lg font-medium transition-all shadow-lg shadow-blue-500/30"
              >
                Sign In
              </Link>
            )}
