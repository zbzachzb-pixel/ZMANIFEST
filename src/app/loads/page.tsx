                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (enabling && loads.length > 0) {
                        toast.warning(
                          'Test Mode: Delete existing loads first',
                          'Loads created before test mode won\'t have the correct date. Delete them or they won\'t clear when advancing days.'
                        )
                      }
                      setIsTestMode(enabling)
                    }}
